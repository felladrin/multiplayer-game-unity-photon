...
/// <summary>
/// Stores data in JSON format and display them on Inspector.
/// Source: https://github.com/felladrin/unity3d-globalstorage
/// </summary>
public class GlobalStorage : MonoBehaviour
{
    ...
    /// <summary>
    /// Saves data on the storage.
    /// </summary>
    /// <param name="key">The identifier for this item</param>
    ...
    /// <returns>The data, already cast to the indicated type</returns>
    ...
    /// </summary>
    /// <param name="key">The identifier of the item to be deleted</param>
